...
# ROOT_DIR = 'C:/Users/Raouf/Documents/raouf/self work/python miscillany/packages/tf/models/object_detection'
...
if __name__ == '__main__':
    ...
    detector.detect(image_1)
    detector.detect(image_2)
    detector.detect(image_3)
